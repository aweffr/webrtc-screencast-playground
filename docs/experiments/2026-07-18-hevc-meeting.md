...
下面保留参数对齐的 A0/A1 Android 关键截图。图片只包含固定的开源 Kubernetes 文档 fixture，分别覆盖三次 run 的初始、中段和最终样本。

### A0：H.264 24/32

![A0 H.264 Android 全景](assets/2026-07-18-hevc-meeting/a0-h264-android-full.png)

![A0 H.264 Android 正文细节](assets/2026-07-18-hevc-meeting/a0-h264-android-detail.png)

### A1：H.265 24/32

![A1 H.265 Android 全景](assets/2026-07-18-hevc-meeting/a1-hevc-aligned-android-full.png)

![A1 H.265 Android 正文细节](assets/2026-07-18-hevc-meeting/a1-hevc-aligned-android-detail.png)

## 可发布证据与隐私处理

原始 evidence 包含构建日志、设备诊断和网络运行信息，仅保留在被 Git ignore 的本地 `artifacts/` 目录，不进入版本库。提交的四张关键截图经过重新编码和扩展属性清理，并检查了嵌入文本与 metadata；未发现用户名、本机路径、邮箱、凭据、设备标识或私有网络地址。版本库只发布聚合结论、不可逆 artifact hash 和固定开源文档画面。
